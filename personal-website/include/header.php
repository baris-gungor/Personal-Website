...
<html>
	<head>
		...
		<meta name="site_description" content="<?=$ayar->site_description?>">
		<meta name="site_keywords" content="<?=$ayar->site_keywords?>">
				...
				<div class="top">
					...
					<!-- Nav -->
						<nav id="nav">
							...
							-->
							<ul>
								<li><a href="http://barisgungor.rf.gd/" id="top-link" class="skel-layers-ignoreHref"><span class="icon fa-home">Anasayfa</span></a></li>
				...
				<div class="bottom">
					...
					<!-- Social Icons -->
						<ul class="icons">
							...
							<li><a href="mailto:<?=$ayar->site_email?>" class="icon fa-envelope"><span class="label"><?=$ayar->site_resim?></span></a></li>
						</ul>
